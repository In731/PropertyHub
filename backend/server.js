...
// Get Single Property
app.get(`${PREFIX}/properties/:id`, async (req, res) => {
  try {
    const { id } = req.params;
...
// Update Property
app.put(`${PREFIX}/properties/:id`, requireAuth, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.userId;
    const body = req.body;
...
// Delete Property
app.delete(`${PREFIX}/properties/:id`, requireAuth, async (req, res) => {
  try {
    const { id } = req.params;
    const userId = req.userId;
...
// Update Review
app.put(`${PREFIX}/properties/:id/reviews/:reviewId`, requireAuth, async (req, res) => {
  try {
...
// Delete Review
app.delete(`${PREFIX}/properties/:id/reviews/:reviewId`, requireAuth, async (req, res) => {
  try {
    const { id, reviewId } = req.params;
    const userId = req.userId;
