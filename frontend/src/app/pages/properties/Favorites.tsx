      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">Loading your favorites...</p>
          </div>
        ) : !user ? (
          <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Log in to view favorites</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">
              You must be logged in to view and save favorite properties.
            </p>
            <button
              onClick={() => navigate('/login')}
              className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold shadow-md shadow-blue-600/20 transition text-sm"
            >
              Log In
            </button>
          </div>
          ...
          <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8">
            <Heart className="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">No Saved Properties</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">
