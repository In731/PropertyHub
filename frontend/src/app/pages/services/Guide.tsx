  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-extrabold">Property Guides</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {propertyGuides.map((guide) => {
              ...
              return (
                <div
                  key={guide.id}
                  className={`${colors.bg} ${colors.border} rounded-3xl p-6 ${colors.hover} transition-all duration-300 cursor-pointer group shadow-sm hover:shadow-md`}
                >
                  <div className={`w-14 h-14 ${colors.iconBg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-105 transition duration-300`}>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200/60 dark:border-gray-800">
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-400">{guide.articles} articles</span>
                    <span className={`${colors.text} font-semibold text-xs flex items-center gap-1 group-hover:translate-x-1 transition`}>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {popularArticles.map((article, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all cursor-pointer group"
              >
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{article.readTime}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Tools Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Helpful Tools</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link 
              to="/services/emi-calculator"
              className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-8 text-white hover:shadow-xl transition group"
            >
              <Calculator className="w-10 h-10 mb-4 group-hover:scale-110 transition" />
              <h3 className="text-xl font-bold mb-2">EMI Calculator</h3>
              <p className="text-blue-100 text-sm mb-4">Calculate your monthly loan payments</p>
            ...
            <Link 
              ...
              className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl p-8 text-white hover:shadow-xl transition group"
            >
              <Home className="w-10 h-10 mb-4 group-hover:scale-110 transition" />
              <h3 className="text-xl font-bold mb-2">Home Loan</h3>
              <p className="text-purple-100 text-sm mb-4">Get the best home loan rates</p>
              <span className="inline-flex items-center gap-2 font-semibold text-sm">
            ...
            <Link 
              ...
              className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 text-white hover:shadow-xl transition group"
            >
              <TrendingUp className="w-10 h-10 mb-4 group-hover:scale-110 transition" />
              <h3 className="text-xl font-bold mb-2">Property Value</h3>
              <p className="text-orange-100 text-sm mb-4">Estimate your property's worth</p>
              <span className="inline-flex items-center gap-2 font-semibold text-sm">
                Check Now <ChevronRight className="w-4 h-4" />
              </span>
            </Link>
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-3xl p-10 text-center text-white shadow-xl shadow-emerald-600/20">
          ...
          <button className="px-8 py-3.5 bg-white text-emerald-700 rounded-xl hover:bg-emerald-50 transition font-bold text-sm shadow-md">
            Talk to an Expert
          </button>
        </div>
      </div>
